...
class _EditarClienteScreenState extends State<EditarClienteScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_iniciado) {
      ...
      _nomeController.text    = _clienteOriginal.nome;
      _celularController.text = _clienteOriginal.celular;
      _emailController.text   = _clienteOriginal.email;
      _ativo                  = _clienteOriginal.ativo;
  ...
  void _salvar() async {
    ...
    final clienteAtualizado = _clienteOriginal.copyWith(
